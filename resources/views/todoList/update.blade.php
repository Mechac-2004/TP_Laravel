...
@section('layout-section')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center my-3">
            <div class="h2">Modification d'une tâche</div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('todo.update') }}" method="post">
                    ...
                    <select name="category_id" class="form-control" value="{{$task->category_id}}">
                        <option value=""></option>
                    ...
                    <input type="date" name="due_date" id="" class="form-control" value="{{$task->due_date}}">
                    <input type="number" name="id" value="{{$task->id}}" hidden>
                    <button class="btn btn-primary btn-lg mt-4">Mettre à jour</button>
                </form>
            </div>
        </div>
